...
def equals():
    ...
    try:
        ...
        # you could also use total = str(eval(equation_label.get()))
        # eval will get the result of the string equation
        ...
        # this is the reason for why we use equation_text variable
        # this will create a different storage in case of exception happens
        equation_text = ""
...
equation_text = ""
# the text is stored in internal space
equation_label = StringVar()
# the label is display the stored text
# ------------------------------------------------------------
label = Label(window,
...
clear = Button(window, text="clear", height=4, width=39,
